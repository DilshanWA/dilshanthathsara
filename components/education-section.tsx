...
const educationData = [
  {
    ...
    achievements: ["Dean's List", "Programming Competition Winner", "Tech Society President"],
    status: "current",
  },
  {
    id: 2,
    ...
    achievements: ["Top 5% in District", "Mathematics Olympiad Participant", "IT Project Award"],
    status: "completed",
  },
]
